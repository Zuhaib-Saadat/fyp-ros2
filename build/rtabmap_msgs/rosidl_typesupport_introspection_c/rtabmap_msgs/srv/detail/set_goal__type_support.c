...
void rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  rtabmap_msgs__srv__SetGoal_Event__init(message_memory);
}

void rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_fini_function(void * message_memory)
{
  rtabmap_msgs__srv__SetGoal_Event__fini(message_memory);
}

size_t rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__size_function__SetGoal_Event__request(
  const void * untyped_member)
{
  const rtabmap_msgs__srv__SetGoal_Request__Sequence * member =
    (const rtabmap_msgs__srv__SetGoal_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__get_const_function__SetGoal_Event__request(
  const void * untyped_member, size_t index)
{
  const rtabmap_msgs__srv__SetGoal_Request__Sequence * member =
    (const rtabmap_msgs__srv__SetGoal_Request__Sequence *)(untyped_member);
...
void * rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__get_function__SetGoal_Event__request(
  void * untyped_member, size_t index)
{
  rtabmap_msgs__srv__SetGoal_Request__Sequence * member =
    (rtabmap_msgs__srv__SetGoal_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__fetch_function__SetGoal_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const rtabmap_msgs__srv__SetGoal_Request * item =
    ((const rtabmap_msgs__srv__SetGoal_Request *)
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__get_const_function__SetGoal_Event__request(untyped_member, index));
  rtabmap_msgs__srv__SetGoal_Request * value =
    (rtabmap_msgs__srv__SetGoal_Request *)(untyped_value);
  *value = *item;
}

void rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__assign_function__SetGoal_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  rtabmap_msgs__srv__SetGoal_Request * item =
    ((rtabmap_msgs__srv__SetGoal_Request *)
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__get_function__SetGoal_Event__request(untyped_member, index));
  const rtabmap_msgs__srv__SetGoal_Request * value =
    (const rtabmap_msgs__srv__SetGoal_Request *)(untyped_value);
  *item = *value;
}

bool rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__resize_function__SetGoal_Event__request(
  void * untyped_member, size_t size)
{
  rtabmap_msgs__srv__SetGoal_Request__Sequence * member =
    (rtabmap_msgs__srv__SetGoal_Request__Sequence *)(untyped_member);
  rtabmap_msgs__srv__SetGoal_Request__Sequence__fini(member);
  return rtabmap_msgs__srv__SetGoal_Request__Sequence__init(member, size);
}

size_t rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__size_function__SetGoal_Event__response(
  const void * untyped_member)
{
  const rtabmap_msgs__srv__SetGoal_Response__Sequence * member =
    (const rtabmap_msgs__srv__SetGoal_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__get_const_function__SetGoal_Event__response(
  const void * untyped_member, size_t index)
{
  const rtabmap_msgs__srv__SetGoal_Response__Sequence * member =
    (const rtabmap_msgs__srv__SetGoal_Response__Sequence *)(untyped_member);
...
void * rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__get_function__SetGoal_Event__response(
  void * untyped_member, size_t index)
{
  rtabmap_msgs__srv__SetGoal_Response__Sequence * member =
    (rtabmap_msgs__srv__SetGoal_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__fetch_function__SetGoal_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const rtabmap_msgs__srv__SetGoal_Response * item =
    ((const rtabmap_msgs__srv__SetGoal_Response *)
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__get_const_function__SetGoal_Event__response(untyped_member, index));
  rtabmap_msgs__srv__SetGoal_Response * value =
    (rtabmap_msgs__srv__SetGoal_Response *)(untyped_value);
  *value = *item;
}

void rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__assign_function__SetGoal_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  rtabmap_msgs__srv__SetGoal_Response * item =
    ((rtabmap_msgs__srv__SetGoal_Response *)
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__get_function__SetGoal_Event__response(untyped_member, index));
  const rtabmap_msgs__srv__SetGoal_Response * value =
    (const rtabmap_msgs__srv__SetGoal_Response *)(untyped_value);
  *item = *value;
}

bool rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__resize_function__SetGoal_Event__response(
  void * untyped_member, size_t size)
{
  rtabmap_msgs__srv__SetGoal_Response__Sequence * member =
    (rtabmap_msgs__srv__SetGoal_Response__Sequence *)(untyped_member);
  rtabmap_msgs__srv__SetGoal_Response__Sequence__fini(member);
  return rtabmap_msgs__srv__SetGoal_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_msgs__srv__SetGoal_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(rtabmap_msgs__srv__SetGoal_Event, request),  // bytes offset in struct
    NULL,  // default value
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__size_function__SetGoal_Event__request,  // size() function pointer
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__get_const_function__SetGoal_Event__request,  // get_const(index) function pointer
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__get_function__SetGoal_Event__request,  // get(index) function pointer
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__fetch_function__SetGoal_Event__request,  // fetch(index, &value) function pointer
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__assign_function__SetGoal_Event__request,  // assign(index, value) function pointer
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__resize_function__SetGoal_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(rtabmap_msgs__srv__SetGoal_Event, response),  // bytes offset in struct
    NULL,  // default value
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__size_function__SetGoal_Event__response,  // size() function pointer
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__get_const_function__SetGoal_Event__response,  // get_const(index) function pointer
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__get_function__SetGoal_Event__response,  // get(index) function pointer
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__fetch_function__SetGoal_Event__response,  // fetch(index, &value) function pointer
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__assign_function__SetGoal_Event__response,  // assign(index, value) function pointer
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__resize_function__SetGoal_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_message_members = {
  "rtabmap_msgs__srv",  // message namespace
  "SetGoal_Event",  // message name
  3,  // number of fields
  sizeof(rtabmap_msgs__srv__SetGoal_Event),
  false,  // has_any_key_member_
  rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_message_member_array,  // message members
  rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_message_type_support_handle = {
  0,
  &rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rtabmap_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, SetGoal_Event)() {
  rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, SetGoal_Request)();
  rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, SetGoal_Response)();
  if (!rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_message_type_support_handle.typesupport_identifier) {
    rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t rtabmap_msgs__srv__detail__set_goal__rosidl_typesupport_introspection_c__SetGoal_service_type_support_handle = {
  ...
  &rtabmap_msgs__srv__SetGoal_Request__rosidl_typesupport_introspection_c__SetGoal_Request_message_type_support_handle,
  &rtabmap_msgs__srv__SetGoal_Response__rosidl_typesupport_introspection_c__SetGoal_Response_message_type_support_handle,
  &rtabmap_msgs__srv__SetGoal_Event__rosidl_typesupport_introspection_c__SetGoal_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, SetGoal_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, SetGoal_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, SetGoal_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rtabmap_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, SetGoal)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, SetGoal_Event)()->data;
  }
