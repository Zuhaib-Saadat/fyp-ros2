...
static const _GetPlan_Event_type_support_symbol_names_t _GetPlan_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, srv, GetPlan_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, GetPlan_Event)),
  }
};
...
{
  return &::rtabmap_msgs::srv::rosidl_typesupport_cpp::GetPlan_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rtabmap_msgs, srv, GetPlan_Event)() {
  return get_message_type_support_handle<rtabmap_msgs::srv::GetPlan_Event>();
}
...
static const rosidl_service_type_support_t GetPlan_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rtabmap_msgs::srv::GetPlan_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rtabmap_msgs::srv::GetPlan_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rtabmap_msgs::srv::GetPlan_Event>(),
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, rtabmap_msgs, srv, GetPlan)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<rtabmap_msgs::srv::GetPlan>();
}
