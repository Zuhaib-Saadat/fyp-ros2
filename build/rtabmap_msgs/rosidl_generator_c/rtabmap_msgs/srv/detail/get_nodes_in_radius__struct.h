...
enum
{
  rtabmap_msgs__srv__GetNodesInRadius_Event__request__MAX_SIZE = 1
};
// response
enum
{
  rtabmap_msgs__srv__GetNodesInRadius_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetNodesInRadius in the package rtabmap_msgs.
typedef struct rtabmap_msgs__srv__GetNodesInRadius_Event
{
  service_msgs__msg__ServiceEventInfo info;
  rtabmap_msgs__srv__GetNodesInRadius_Request__Sequence request;
  rtabmap_msgs__srv__GetNodesInRadius_Response__Sequence response;
} rtabmap_msgs__srv__GetNodesInRadius_Event;

// Struct for a sequence of rtabmap_msgs__srv__GetNodesInRadius_Event.
typedef struct rtabmap_msgs__srv__GetNodesInRadius_Event__Sequence
{
