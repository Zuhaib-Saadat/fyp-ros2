...
class Metaclass_ListLabels_Event(type):
    """Metaclass of message 'ListLabels_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__list_labels__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__list_labels__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__list_labels__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__list_labels__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__list_labels__event
...
class ListLabels_Event(metaclass=Metaclass_ListLabels_Event):
    """Message class 'ListLabels_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rtabmap_msgs/ListLabels_Request, 1>',
        'response': 'sequence<rtabmap_msgs/ListLabels_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'srv'], 'ListLabels_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'srv'], 'ListLabels_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rtabmap_msgs.srv import ListLabels_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListLabels_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ListLabels_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rtabmap_msgs.srv import ListLabels_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ListLabels_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ListLabels_Response'"
...
class Metaclass_ListLabels(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _list_labels.Metaclass_ListLabels_Event._TYPE_SUPPORT is None:
                _list_labels.Metaclass_ListLabels_Event.__import_type_support__()
...
class ListLabels(metaclass=Metaclass_ListLabels):
    ...
    from rtabmap_msgs.srv._list_labels import ListLabels_Event as Event
