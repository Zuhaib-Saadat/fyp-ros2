...
class GetMap_Event(metaclass=Metaclass_GetMap_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rtabmap_msgs/GetMap_Request, 1>',
        'response': 'sequence<rtabmap_msgs/GetMap_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'srv'], 'GetMap_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'srv'], 'GetMap_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rtabmap_msgs.srv import GetMap_Request
    ...
    def response(self, value):
        if self._check_fields:
            from rtabmap_msgs.srv import GetMap_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class GetMap(metaclass=Metaclass_GetMap):
    ...
    from rtabmap_msgs.srv._get_map import GetMap_Event as Event
