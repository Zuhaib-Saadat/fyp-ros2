  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtabmap_msgs__msg__Link;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rtabmap_msgs__msg__Link * ros_message = static_cast<const rtabmap_msgs__msg__Link *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rtabmap_msgs__msg__Link(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rtabmap_msgs__msg__Link * ros_message = static_cast<rtabmap_msgs__msg__Link *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rtabmap_msgs__msg__Link(cdr, ros_message);
}
...
static size_t _Link__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rtabmap_msgs__msg__Link(
