...
rtabmap_msgs__msg__CameraModels__get_type_hash(
...
static char rtabmap_msgs__msg__CameraModels__FIELD_NAME__models[] = "models";

static rosidl_runtime_c__type_description__Field rtabmap_msgs__msg__CameraModels__FIELDS[] = {
  {
    {rtabmap_msgs__msg__CameraModels__FIELD_NAME__models, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rtabmap_msgs__msg__CameraModels__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
rtabmap_msgs__msg__CameraModels__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rtabmap_msgs__msg__CameraModels__FIELDS, 1, 1},
    },
    {rtabmap_msgs__msg__CameraModels__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[4].fields = rtabmap_msgs__msg__CameraModel__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[6].fields = sensor_msgs__msg__RegionOfInterest__get_type_description(NULL)->type_description.fields;
...
rtabmap_msgs__msg__CameraModels__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
rtabmap_msgs__msg__CameraModels__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rtabmap_msgs__msg__CameraModels__get_individual_type_description_source(NULL),
    ...
    sources[5] = *rtabmap_msgs__msg__CameraModel__get_individual_type_description_source(NULL);
    sources[6] = *sensor_msgs__msg__CameraInfo__get_individual_type_description_source(NULL);
    sources[7] = *sensor_msgs__msg__RegionOfInterest__get_individual_type_description_source(NULL);
