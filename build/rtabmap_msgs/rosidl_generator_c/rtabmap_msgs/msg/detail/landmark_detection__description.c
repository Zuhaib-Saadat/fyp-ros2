...
rtabmap_msgs__msg__LandmarkDetection__get_type_hash(
...
static char rtabmap_msgs__msg__LandmarkDetection__FIELD_NAME__header[] = "header";
static char rtabmap_msgs__msg__LandmarkDetection__FIELD_NAME__landmark_frame_id[] = "landmark_frame_id";
static char rtabmap_msgs__msg__LandmarkDetection__FIELD_NAME__id[] = "id";
static char rtabmap_msgs__msg__LandmarkDetection__FIELD_NAME__size[] = "size";
static char rtabmap_msgs__msg__LandmarkDetection__FIELD_NAME__pose[] = "pose";

static rosidl_runtime_c__type_description__Field rtabmap_msgs__msg__LandmarkDetection__FIELDS[] = {
  {
    {rtabmap_msgs__msg__LandmarkDetection__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {rtabmap_msgs__msg__LandmarkDetection__FIELD_NAME__landmark_frame_id, 17, 17},
    {
  ...
  {
    {rtabmap_msgs__msg__LandmarkDetection__FIELD_NAME__id, 2, 2},
    {
  ...
  {
    {rtabmap_msgs__msg__LandmarkDetection__FIELD_NAME__size, 4, 4},
    {
  ...
  {
    {rtabmap_msgs__msg__LandmarkDetection__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rtabmap_msgs__msg__LandmarkDetection__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
rtabmap_msgs__msg__LandmarkDetection__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rtabmap_msgs__msg__LandmarkDetection__FIELDS, 5, 5},
    },
    {rtabmap_msgs__msg__LandmarkDetection__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
rtabmap_msgs__msg__LandmarkDetection__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
rtabmap_msgs__msg__LandmarkDetection__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rtabmap_msgs__msg__LandmarkDetection__get_individual_type_description_source(NULL),
