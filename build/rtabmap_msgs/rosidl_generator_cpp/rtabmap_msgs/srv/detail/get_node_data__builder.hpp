...
class Init_GetNodeData_Event_response
{
public:
  explicit Init_GetNodeData_Event_response(::rtabmap_msgs::srv::GetNodeData_Event & msg)
  : msg_(msg)
  {}
  ::rtabmap_msgs::srv::GetNodeData_Event response(::rtabmap_msgs::srv::GetNodeData_Event::_response_type arg)
  {
...
private:
  ::rtabmap_msgs::srv::GetNodeData_Event msg_;
};

class Init_GetNodeData_Event_request
{
public:
  explicit Init_GetNodeData_Event_request(::rtabmap_msgs::srv::GetNodeData_Event & msg)
  : msg_(msg)
  {}
  Init_GetNodeData_Event_response request(::rtabmap_msgs::srv::GetNodeData_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GetNodeData_Event_response(msg_);
  }
...
class Init_GetNodeData_Event_info
{
public:
  Init_GetNodeData_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetNodeData_Event_request info(::rtabmap_msgs::srv::GetNodeData_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GetNodeData_Event_request(msg_);
  }
...
template<>
inline
auto build<::rtabmap_msgs::srv::GetNodeData_Event>()
{
  return rtabmap_msgs::srv::builder::Init_GetNodeData_Event_info();
}
