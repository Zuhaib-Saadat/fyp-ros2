...
bool cdr_serialize_rtabmap_msgs__msg__MapGraph(
  const rtabmap_msgs__msg__MapGraph * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_msgs
bool cdr_deserialize_rtabmap_msgs__msg__MapGraph(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_msgs__msg__MapGraph * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: map_to_odom
  {
    cdr_deserialize_geometry_msgs__msg__Transform(cdr, &ros_message->map_to_odom);
  }
  ...
  // Field name: links
  {
    ...
    auto array_ptr = ros_message->links.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rtabmap_msgs__msg__Link(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtabmap_msgs__msg__MapGraph;
    is_plain =
      (
      offsetof(DataType, links) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_msgs
bool cdr_serialize_key_rtabmap_msgs__msg__MapGraph(
  const rtabmap_msgs__msg__MapGraph * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_msgs
size_t get_serialized_size_key_rtabmap_msgs__msg__MapGraph(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MapGraph__ros_msg_type * ros_message = static_cast<const _MapGraph__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_msgs
size_t max_serialized_size_key_rtabmap_msgs__msg__MapGraph(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rtabmap_msgs__msg__MapGraph * ros_message = static_cast<const rtabmap_msgs__msg__MapGraph *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rtabmap_msgs__msg__MapGraph(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rtabmap_msgs__msg__MapGraph * ros_message = static_cast<rtabmap_msgs__msg__MapGraph *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rtabmap_msgs__msg__MapGraph(cdr, ros_message);
}
...
static size_t _MapGraph__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rtabmap_msgs__msg__MapGraph(
...
static rosidl_message_type_support_t _MapGraph__type_support = {
  ...
  &rtabmap_msgs__msg__MapGraph__get_type_hash,
  &rtabmap_msgs__msg__MapGraph__get_type_description,
  &rtabmap_msgs__msg__MapGraph__get_type_description_sources,
};
