...
// IWYU pragma: private, include "rtabmap_msgs/msg/landmark_detections.hpp"
...
inline std::string to_yaml(const LandmarkDetections & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const rtabmap_msgs::msg::LandmarkDetections & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rtabmap_msgs::msg::LandmarkDetections & msg)
{
