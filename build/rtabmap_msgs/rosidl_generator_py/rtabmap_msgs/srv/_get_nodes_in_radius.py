...
class Metaclass_GetNodesInRadius_Event(type):
    """Metaclass of message 'GetNodesInRadius_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_nodes_in_radius__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_nodes_in_radius__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_nodes_in_radius__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_nodes_in_radius__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_nodes_in_radius__event
...
class GetNodesInRadius_Event(metaclass=Metaclass_GetNodesInRadius_Event):
    """Message class 'GetNodesInRadius_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rtabmap_msgs/GetNodesInRadius_Request, 1>',
        'response': 'sequence<rtabmap_msgs/GetNodesInRadius_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'srv'], 'GetNodesInRadius_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'srv'], 'GetNodesInRadius_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rtabmap_msgs.srv import GetNodesInRadius_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetNodesInRadius_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetNodesInRadius_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rtabmap_msgs.srv import GetNodesInRadius_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetNodesInRadius_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetNodesInRadius_Response'"
...
class Metaclass_GetNodesInRadius(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_nodes_in_radius.Metaclass_GetNodesInRadius_Event._TYPE_SUPPORT is None:
                _get_nodes_in_radius.Metaclass_GetNodesInRadius_Event.__import_type_support__()
...
class GetNodesInRadius(metaclass=Metaclass_GetNodesInRadius):
    ...
    from rtabmap_msgs.srv._get_nodes_in_radius import GetNodesInRadius_Event as Event
