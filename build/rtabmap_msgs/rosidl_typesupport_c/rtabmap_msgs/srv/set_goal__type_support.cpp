...
static const _SetGoal_Event_type_support_symbol_names_t _SetGoal_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_msgs, srv, SetGoal_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, SetGoal_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rtabmap_msgs, srv, SetGoal_Event)() {
  return &::rtabmap_msgs::srv::rosidl_typesupport_c::SetGoal_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetGoal_service_type_support_handle = {
  ...
  &SetGoal_Request_message_type_support_handle,
  &SetGoal_Response_message_type_support_handle,
  &SetGoal_Event_message_type_support_handle,
