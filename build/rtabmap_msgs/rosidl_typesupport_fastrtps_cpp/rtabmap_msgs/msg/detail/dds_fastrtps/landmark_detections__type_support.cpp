  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtabmap_msgs::msg::LandmarkDetections;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rtabmap_msgs
max_serialized_size_key_LandmarkDetections(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _LandmarkDetections__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LandmarkDetections(full_bounded, is_plain, 0);
