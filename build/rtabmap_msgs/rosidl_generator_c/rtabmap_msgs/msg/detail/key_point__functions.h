...
// IWYU pragma: private, include "rtabmap_msgs/msg/key_point.h"


#ifndef RTABMAP_MSGS__MSG__DETAIL__KEY_POINT__FUNCTIONS_H_
#define RTABMAP_MSGS__MSG__DETAIL__KEY_POINT__FUNCTIONS_H_
 ...
 * calls
 * rtabmap_msgs__msg__KeyPoint__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_msgs
rtabmap_msgs__msg__KeyPoint *
rtabmap_msgs__msg__KeyPoint__create(void);

/// Destroy msg/KeyPoint message.
/**
 * It calls
 * rtabmap_msgs__msg__KeyPoint__fini()
 ...
 * rtabmap_msgs__msg__KeyPoint__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rtabmap_msgs__msg__KeyPoint__Sequence__fini()
 * on the array,
...
#endif  // RTABMAP_MSGS__MSG__DETAIL__KEY_POINT__FUNCTIONS_H_
