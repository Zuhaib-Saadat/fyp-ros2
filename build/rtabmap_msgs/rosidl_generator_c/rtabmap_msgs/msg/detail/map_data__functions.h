...
// IWYU pragma: private, include "rtabmap_msgs/msg/map_data.h"


#ifndef RTABMAP_MSGS__MSG__DETAIL__MAP_DATA__FUNCTIONS_H_
#define RTABMAP_MSGS__MSG__DETAIL__MAP_DATA__FUNCTIONS_H_
 ...
 * calls
 * rtabmap_msgs__msg__MapData__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_msgs
rtabmap_msgs__msg__MapData *
rtabmap_msgs__msg__MapData__create(void);

/// Destroy msg/MapData message.
/**
 * It calls
 * rtabmap_msgs__msg__MapData__fini()
 ...
 * rtabmap_msgs__msg__MapData__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rtabmap_msgs__msg__MapData__Sequence__fini()
 * on the array,
...
#endif  // RTABMAP_MSGS__MSG__DETAIL__MAP_DATA__FUNCTIONS_H_
