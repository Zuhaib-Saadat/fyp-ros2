  ...
  rtabmap_msgs__msg__KeyPoint * ros_message)
{
  // Field name: pt
  {
    cdr_deserialize_rtabmap_msgs__msg__Point2f(cdr, &ros_message->pt);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rtabmap_msgs__msg__KeyPoint * ros_message = static_cast<const rtabmap_msgs__msg__KeyPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rtabmap_msgs__msg__KeyPoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rtabmap_msgs__msg__KeyPoint * ros_message = static_cast<rtabmap_msgs__msg__KeyPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rtabmap_msgs__msg__KeyPoint(cdr, ros_message);
}
