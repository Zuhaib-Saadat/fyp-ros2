...
enum
{
  rtabmap_msgs__srv__GetMap2_Event__request__MAX_SIZE = 1
};
// response
enum
{
  rtabmap_msgs__srv__GetMap2_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetMap2 in the package rtabmap_msgs.
typedef struct rtabmap_msgs__srv__GetMap2_Event
{
  service_msgs__msg__ServiceEventInfo info;
  rtabmap_msgs__srv__GetMap2_Request__Sequence request;
  rtabmap_msgs__srv__GetMap2_Response__Sequence response;
} rtabmap_msgs__srv__GetMap2_Event;

// Struct for a sequence of rtabmap_msgs__srv__GetMap2_Event.
typedef struct rtabmap_msgs__srv__GetMap2_Event__Sequence
{
