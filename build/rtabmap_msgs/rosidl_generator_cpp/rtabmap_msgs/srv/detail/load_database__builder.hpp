...
class Init_LoadDatabase_Event_response
{
public:
  explicit Init_LoadDatabase_Event_response(::rtabmap_msgs::srv::LoadDatabase_Event & msg)
  : msg_(msg)
  {}
  ::rtabmap_msgs::srv::LoadDatabase_Event response(::rtabmap_msgs::srv::LoadDatabase_Event::_response_type arg)
  {
...
private:
  ::rtabmap_msgs::srv::LoadDatabase_Event msg_;
};

class Init_LoadDatabase_Event_request
{
public:
  explicit Init_LoadDatabase_Event_request(::rtabmap_msgs::srv::LoadDatabase_Event & msg)
  : msg_(msg)
  {}
  Init_LoadDatabase_Event_response request(::rtabmap_msgs::srv::LoadDatabase_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_LoadDatabase_Event_response(msg_);
  }
...
class Init_LoadDatabase_Event_info
{
public:
  Init_LoadDatabase_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_LoadDatabase_Event_request info(::rtabmap_msgs::srv::LoadDatabase_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_LoadDatabase_Event_request(msg_);
  }
...
template<>
inline
auto build<::rtabmap_msgs::srv::LoadDatabase_Event>()
{
  return rtabmap_msgs::srv::builder::Init_LoadDatabase_Event_info();
}
