...
inline void to_flow_style_yaml(
  const GlobalBundleAdjustment_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const GlobalBundleAdjustment_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use rtabmap_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rtabmap_msgs::srv::GlobalBundleAdjustment_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  rtabmap_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rtabmap_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const rtabmap_msgs::srv::GlobalBundleAdjustment_Event & msg)
{
  return rtabmap_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rtabmap_msgs::srv::GlobalBundleAdjustment_Event>()
{
  return "rtabmap_msgs::srv::GlobalBundleAdjustment_Event";
}

template<>
inline const char * name<rtabmap_msgs::srv::GlobalBundleAdjustment_Event>()
{
  return "rtabmap_msgs/srv/GlobalBundleAdjustment_Event";
}

template<>
struct has_fixed_size<rtabmap_msgs::srv::GlobalBundleAdjustment_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rtabmap_msgs::srv::GlobalBundleAdjustment_Event>
  : std::integral_constant<bool, has_bounded_size<rtabmap_msgs::srv::GlobalBundleAdjustment_Request>::value && has_bounded_size<rtabmap_msgs::srv::GlobalBundleAdjustment_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<rtabmap_msgs::srv::GlobalBundleAdjustment_Event>
  : std::true_type {};
