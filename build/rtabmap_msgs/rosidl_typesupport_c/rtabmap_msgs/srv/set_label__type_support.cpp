...
static const _SetLabel_Event_type_support_symbol_names_t _SetLabel_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_msgs, srv, SetLabel_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, SetLabel_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rtabmap_msgs, srv, SetLabel_Event)() {
  return &::rtabmap_msgs::srv::rosidl_typesupport_c::SetLabel_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetLabel_service_type_support_handle = {
  ...
  &SetLabel_Request_message_type_support_handle,
  &SetLabel_Response_message_type_support_handle,
  &SetLabel_Event_message_type_support_handle,
