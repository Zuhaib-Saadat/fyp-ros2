...
void fetch_function__Path__node_ids(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int32_t *>(
    get_const_function__Path__node_ids(untyped_member, index));
  auto & value = *reinterpret_cast<int32_t *>(untyped_value);
  value = item;
}

void assign_function__Path__node_ids(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int32_t *>(
    get_function__Path__node_ids(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Path_message_member_array[3] = {
  ...
  },
  {
    ...
    fetch_function__Path__node_ids,  // fetch(index, &value) function pointer
    assign_function__Path__node_ids,  // assign(index, value) function pointer
