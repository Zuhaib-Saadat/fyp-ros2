  ...
  rtabmap_msgs__msg__RGBDImage * ros_message)
{
  ...
  // Field name: rgb_compressed
  {
    cdr_deserialize_sensor_msgs__msg__CompressedImage(cdr, &ros_message->rgb_compressed);
  }

  // Field name: depth_compressed
  {
    cdr_deserialize_sensor_msgs__msg__CompressedImage(cdr, &ros_message->depth_compressed);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtabmap_msgs__msg__RGBDImage;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rtabmap_msgs__msg__RGBDImage * ros_message = static_cast<const rtabmap_msgs__msg__RGBDImage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rtabmap_msgs__msg__RGBDImage(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rtabmap_msgs__msg__RGBDImage * ros_message = static_cast<rtabmap_msgs__msg__RGBDImage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rtabmap_msgs__msg__RGBDImage(cdr, ros_message);
}
...
static size_t _RGBDImage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rtabmap_msgs__msg__RGBDImage(
