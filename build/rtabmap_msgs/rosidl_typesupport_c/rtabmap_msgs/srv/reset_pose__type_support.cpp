...
static const _ResetPose_Event_type_support_symbol_names_t _ResetPose_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_msgs, srv, ResetPose_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, ResetPose_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rtabmap_msgs, srv, ResetPose_Event)() {
  return &::rtabmap_msgs::srv::rosidl_typesupport_c::ResetPose_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t ResetPose_service_type_support_handle = {
  ...
  &ResetPose_Request_message_type_support_handle,
  &ResetPose_Response_message_type_support_handle,
  &ResetPose_Event_message_type_support_handle,
