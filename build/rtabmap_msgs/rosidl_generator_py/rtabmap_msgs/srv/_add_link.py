...
class Metaclass_AddLink_Event(type):
    """Metaclass of message 'AddLink_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__add_link__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__add_link__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__add_link__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__add_link__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__add_link__event
...
class AddLink_Event(metaclass=Metaclass_AddLink_Event):
    """Message class 'AddLink_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rtabmap_msgs/AddLink_Request, 1>',
        'response': 'sequence<rtabmap_msgs/AddLink_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'srv'], 'AddLink_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'srv'], 'AddLink_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rtabmap_msgs.srv import AddLink_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, AddLink_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'AddLink_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rtabmap_msgs.srv import AddLink_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, AddLink_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'AddLink_Response'"
...
class Metaclass_AddLink(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _add_link.Metaclass_AddLink_Event._TYPE_SUPPORT is None:
                _add_link.Metaclass_AddLink_Event.__import_type_support__()
...
class AddLink(metaclass=Metaclass_AddLink):
    ...
    from rtabmap_msgs.srv._add_link import AddLink_Event as Event
