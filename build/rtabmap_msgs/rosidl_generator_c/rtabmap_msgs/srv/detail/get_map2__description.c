  ...
  const rosidl_service_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x4a, 0x04, 0x80, 0xe3, 0xc6, 0xc0, 0xdc, 0x7a,
      0x8d, 0xf0, 0x86, 0xa5, 0x28, 0x96, 0x60, 0x6a,
      0xd7, 0x33, 0x07, 0x47, 0x1a, 0x5c, 0x32, 0x56,
      0xd4, 0x73, 0x39, 0xdd, 0xae, 0xf0, 0xd2, 0x36,
    }};
  return &hash;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0xdd, 0xf4, 0xa6, 0xd7, 0x56, 0xc4, 0x75, 0x64,
      0xc4, 0x31, 0x37, 0x52, 0x02, 0xa3, 0x71, 0x0f,
      0x12, 0xe7, 0x7c, 0x8d, 0x03, 0xa2, 0xaa, 0x2e,
      0xee, 0xdf, 0x4d, 0x28, 0x8d, 0x0a, 0x8f, 0xe0,
    }};
  return &hash;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0xcf, 0x6f, 0x87, 0xfc, 0x68, 0xf0, 0xf7, 0x3e,
      0x31, 0x26, 0x5f, 0x40, 0x7b, 0x4f, 0x33, 0xdb,
      0x2e, 0x4f, 0xf3, 0x06, 0x06, 0xef, 0x4b, 0x0c,
      0xf2, 0x9d, 0x1d, 0xeb, 0x0c, 0xc3, 0x9d, 0x44,
    }};
  return &hash;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0xa4, 0x06, 0x59, 0x72, 0xd2, 0xa4, 0xcb, 0x1b,
      0xcc, 0x20, 0x1f, 0xa4, 0x02, 0xaf, 0x2e, 0x27,
      0x2c, 0x56, 0x82, 0xa0, 0x48, 0x45, 0xeb, 0x5a,
      0xdd, 0xce, 0x3c, 0x4d, 0xdc, 0xad, 0xd7, 0xb4,
    }};
  return &hash;
}
...
static char rtabmap_msgs__srv__GetMap2__TYPE_NAME[] = "rtabmap_msgs/srv/GetMap2";
...
static char rtabmap_msgs__srv__GetMap2_Event__TYPE_NAME[] = "rtabmap_msgs/srv/GetMap2_Event";
static char rtabmap_msgs__srv__GetMap2_Request__TYPE_NAME[] = "rtabmap_msgs/srv/GetMap2_Request";
static char rtabmap_msgs__srv__GetMap2_Response__TYPE_NAME[] = "rtabmap_msgs/srv/GetMap2_Response";
...
static char rtabmap_msgs__srv__GetMap2__FIELD_NAME__request_message[] = "request_message";
static char rtabmap_msgs__srv__GetMap2__FIELD_NAME__response_message[] = "response_message";
static char rtabmap_msgs__srv__GetMap2__FIELD_NAME__event_message[] = "event_message";

static rosidl_runtime_c__type_description__Field rtabmap_msgs__srv__GetMap2__FIELDS[] = {
  {
    {rtabmap_msgs__srv__GetMap2__FIELD_NAME__request_message, 15, 15},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
      {rtabmap_msgs__srv__GetMap2_Request__TYPE_NAME, 32, 32},
    },
    {NULL, 0, 0},
  },
  {
    {rtabmap_msgs__srv__GetMap2__FIELD_NAME__response_message, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
      {rtabmap_msgs__srv__GetMap2_Response__TYPE_NAME, 33, 33},
    },
    {NULL, 0, 0},
  },
  {
    {rtabmap_msgs__srv__GetMap2__FIELD_NAME__event_message, 13, 13},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
      {rtabmap_msgs__srv__GetMap2_Event__TYPE_NAME, 30, 30},
    },
    {NULL, 0, 0},
  },
};

static rosidl_runtime_c__type_description__IndividualTypeDescription rtabmap_msgs__srv__GetMap2__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_service_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {rtabmap_msgs__srv__GetMap2__TYPE_NAME, 24, 24},
      {rtabmap_msgs__srv__GetMap2__FIELDS, 3, 3},
    },
    {rtabmap_msgs__srv__GetMap2__REFERENCED_TYPE_DESCRIPTIONS, 30, 30},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[19].fields = rtabmap_msgs__srv__GetMap2_Event__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[20].fields = rtabmap_msgs__srv__GetMap2_Request__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[21].fields = rtabmap_msgs__srv__GetMap2_Response__get_type_description(NULL)->type_description.fields;
...
// Define type names, field names, and default values
static char rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__global_map[] = "global_map";
static char rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__optimized[] = "optimized";
static char rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__with_images[] = "with_images";
static char rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__with_scans[] = "with_scans";
static char rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__with_user_data[] = "with_user_data";
static char rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__with_grids[] = "with_grids";
static char rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__with_words[] = "with_words";
static char rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__with_global_descriptors[] = "with_global_descriptors";

static rosidl_runtime_c__type_description__Field rtabmap_msgs__srv__GetMap2_Request__FIELDS[] = {
  {
    {rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__global_map, 10, 10},
    {
  ...
  {
    {rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__optimized, 9, 9},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__with_images, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__with_scans, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__with_user_data, 14, 14},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__with_grids, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__with_words, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {rtabmap_msgs__srv__GetMap2_Request__FIELD_NAME__with_global_descriptors, 23, 23},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {rtabmap_msgs__srv__GetMap2_Request__TYPE_NAME, 32, 32},
      {rtabmap_msgs__srv__GetMap2_Request__FIELDS, 8, 8},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
...
// Define type names, field names, and default values
static char rtabmap_msgs__srv__GetMap2_Response__FIELD_NAME__data[] = "data";

static rosidl_runtime_c__type_description__Field rtabmap_msgs__srv__GetMap2_Response__FIELDS[] = {
  {
    {rtabmap_msgs__srv__GetMap2_Response__FIELD_NAME__data, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rtabmap_msgs__srv__GetMap2_Response__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {builtin_interfaces__msg__Time__TYPE_NAME, 27, 27},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {rtabmap_msgs__srv__GetMap2_Response__TYPE_NAME, 33, 33},
      {rtabmap_msgs__srv__GetMap2_Response__FIELDS, 1, 1},
    },
    {rtabmap_msgs__srv__GetMap2_Response__REFERENCED_TYPE_DESCRIPTIONS, 26, 26},
  };
  if (!constructed) {
    assert(0 == memcmp(&builtin_interfaces__msg__Time__EXPECTED_HASH, builtin_interfaces__msg__Time__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = builtin_interfaces__msg__Time__get_type_description(NULL)->type_description.fields;
...
// Define type names, field names, and default values
static char rtabmap_msgs__srv__GetMap2_Event__FIELD_NAME__info[] = "info";
static char rtabmap_msgs__srv__GetMap2_Event__FIELD_NAME__request[] = "request";
static char rtabmap_msgs__srv__GetMap2_Event__FIELD_NAME__response[] = "response";

static rosidl_runtime_c__type_description__Field rtabmap_msgs__srv__GetMap2_Event__FIELDS[] = {
  {
    {rtabmap_msgs__srv__GetMap2_Event__FIELD_NAME__info, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {rtabmap_msgs__srv__GetMap2_Event__FIELD_NAME__request, 7, 7},
    {
  ...
  {
    {rtabmap_msgs__srv__GetMap2_Event__FIELD_NAME__response, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_BOUNDED_SEQUENCE,
      1,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rtabmap_msgs__srv__GetMap2_Event__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {builtin_interfaces__msg__Time__TYPE_NAME, 27, 27},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {rtabmap_msgs__srv__GetMap2_Event__TYPE_NAME, 30, 30},
      {rtabmap_msgs__srv__GetMap2_Event__FIELDS, 3, 3},
    },
    {rtabmap_msgs__srv__GetMap2_Event__REFERENCED_TYPE_DESCRIPTIONS, 29, 29},
  };
  if (!constructed) {
    assert(0 == memcmp(&builtin_interfaces__msg__Time__EXPECTED_HASH, builtin_interfaces__msg__Time__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = builtin_interfaces__msg__Time__get_type_description(NULL)->type_description.fields;
    ...
    assert(0 == memcmp(&rtabmap_msgs__msg__SensorData__EXPECTED_HASH, rtabmap_msgs__msg__SensorData__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[18].fields = rtabmap_msgs__msg__SensorData__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[19].fields = rtabmap_msgs__srv__GetMap2_Request__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[20].fields = rtabmap_msgs__srv__GetMap2_Response__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&sensor_msgs__msg__CameraInfo__EXPECTED_HASH, sensor_msgs__msg__CameraInfo__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
...
rtabmap_msgs__srv__GetMap2__get_individual_type_description_source(
  const rosidl_service_type_support_t * type_support)
{
  (void)type_support;
...
const rosidl_runtime_c__type_description__TypeSource *
rtabmap_msgs__srv__GetMap2_Request__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
...
const rosidl_runtime_c__type_description__TypeSource *
rtabmap_msgs__srv__GetMap2_Response__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
...
const rosidl_runtime_c__type_description__TypeSource *
rtabmap_msgs__srv__GetMap2_Event__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
  ...
  const rosidl_service_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rtabmap_msgs__srv__GetMap2__get_individual_type_description_source(NULL),
    ...
    sources[20] = *rtabmap_msgs__srv__GetMap2_Event__get_individual_type_description_source(NULL);
    sources[21] = *rtabmap_msgs__srv__GetMap2_Request__get_individual_type_description_source(NULL);
    sources[22] = *rtabmap_msgs__srv__GetMap2_Response__get_individual_type_description_source(NULL);
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rtabmap_msgs__srv__GetMap2_Request__get_individual_type_description_source(NULL),
    constructed = true;
  }
  return &source_sequence;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rtabmap_msgs__srv__GetMap2_Response__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *geometry_msgs__msg__Point__get_individual_type_description_source(NULL);
    sources[3] = *geometry_msgs__msg__Pose__get_individual_type_description_source(NULL);
    sources[4] = *geometry_msgs__msg__PoseWithCovariance__get_individual_type_description_source(NULL);
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rtabmap_msgs__srv__GetMap2_Event__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *geometry_msgs__msg__Point__get_individual_type_description_source(NULL);
    sources[3] = *geometry_msgs__msg__Pose__get_individual_type_description_source(NULL);
    sources[4] = *geometry_msgs__msg__PoseWithCovariance__get_individual_type_description_source(NULL);
    ...
    sources[18] = *rtabmap_msgs__msg__Point3f__get_individual_type_description_source(NULL);
    sources[19] = *rtabmap_msgs__msg__SensorData__get_individual_type_description_source(NULL);
    sources[20] = *rtabmap_msgs__srv__GetMap2_Request__get_individual_type_description_source(NULL);
    sources[21] = *rtabmap_msgs__srv__GetMap2_Response__get_individual_type_description_source(NULL);
