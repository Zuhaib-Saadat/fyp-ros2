...
// IWYU pragma: private, include "rtabmap_msgs/srv/get_map2.h"


#ifndef RTABMAP_MSGS__SRV__DETAIL__GET_MAP2__FUNCTIONS_H_
#define RTABMAP_MSGS__SRV__DETAIL__GET_MAP2__FUNCTIONS_H_
...
/// Initialize srv/GetMap2 message.
/**
...
/// Create srv/GetMap2 message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rtabmap_msgs__srv__GetMap2_Request__init().
...
/// Destroy srv/GetMap2 message.
/**
 * It calls
 * rtabmap_msgs__srv__GetMap2_Request__fini()
...
/// Check for srv/GetMap2 message equality.
/**
...
/// Initialize array of srv/GetMap2 messages.
/**
...
/// Finalize array of srv/GetMap2 messages.
/**
 * It calls
 * rtabmap_msgs__srv__GetMap2_Request__fini()
...
/// Create array of srv/GetMap2 messages.
/**
 * It allocates the memory for the array and calls
 * rtabmap_msgs__srv__GetMap2_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetMap2 messages.
/**
 * It calls
 * rtabmap_msgs__srv__GetMap2_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetMap2 message array equality.
/**
...
/// Copy an array of srv/GetMap2 messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rtabmap_msgs__srv__GetMap2_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_msgs
...
/**
 * It calls
 * rtabmap_msgs__srv__GetMap2_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_msgs
...
/**
 * It allocates the memory for the array and calls
 * rtabmap_msgs__srv__GetMap2_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_msgs
...
/**
 * It calls
 * rtabmap_msgs__srv__GetMap2_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * rtabmap_msgs__srv__GetMap2_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rtabmap_msgs__srv__GetMap2_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_msgs
...
/**
 * It calls
 * rtabmap_msgs__srv__GetMap2_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_msgs
...
/**
 * It allocates the memory for the array and calls
 * rtabmap_msgs__srv__GetMap2_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_msgs
...
/**
 * It calls
 * rtabmap_msgs__srv__GetMap2_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RTABMAP_MSGS__SRV__DETAIL__GET_MAP2__FUNCTIONS_H_
