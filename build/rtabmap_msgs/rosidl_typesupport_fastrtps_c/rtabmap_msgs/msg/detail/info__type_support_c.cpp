...
bool cdr_serialize_rtabmap_msgs__msg__Info(
  const rtabmap_msgs__msg__Info * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  {
    cdr_serialize_rtabmap_msgs__msg__MapGraph(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_msgs
bool cdr_deserialize_rtabmap_msgs__msg__Info(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_msgs__msg__Info * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: loop_closure_transform
  {
    cdr_deserialize_geometry_msgs__msg__Transform(cdr, &ros_message->loop_closure_transform);
  }
  ...
  // Field name: odom_cache
  {
    cdr_deserialize_rtabmap_msgs__msg__MapGraph(cdr, &ros_message->odom_cache);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_msgs
bool cdr_serialize_key_rtabmap_msgs__msg__Info(
  const rtabmap_msgs__msg__Info * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: odom_cache
  {
    cdr_serialize_key_rtabmap_msgs__msg__MapGraph(
      &ros_message->odom_cache, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_msgs
size_t get_serialized_size_key_rtabmap_msgs__msg__Info(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Info__ros_msg_type * ros_message = static_cast<const _Info__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: odom_cache
  current_alignment += get_serialized_size_key_rtabmap_msgs__msg__MapGraph(
    &(ros_message->odom_cache), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_msgs
size_t max_serialized_size_key_rtabmap_msgs__msg__Info(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: odom_cache
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rtabmap_msgs__msg__MapGraph(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rtabmap_msgs__msg__Info * ros_message = static_cast<const rtabmap_msgs__msg__Info *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rtabmap_msgs__msg__Info(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rtabmap_msgs__msg__Info * ros_message = static_cast<rtabmap_msgs__msg__Info *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rtabmap_msgs__msg__Info(cdr, ros_message);
}
