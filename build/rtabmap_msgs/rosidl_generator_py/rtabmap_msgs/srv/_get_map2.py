...
class Metaclass_GetMap2_Event(type):
    """Metaclass of message 'GetMap2_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_map2__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_map2__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_map2__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_map2__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_map2__event
...
class GetMap2_Event(metaclass=Metaclass_GetMap2_Event):
    """Message class 'GetMap2_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rtabmap_msgs/GetMap2_Request, 1>',
        'response': 'sequence<rtabmap_msgs/GetMap2_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'srv'], 'GetMap2_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'srv'], 'GetMap2_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rtabmap_msgs.srv import GetMap2_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetMap2_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetMap2_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rtabmap_msgs.srv import GetMap2_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetMap2_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetMap2_Response'"
...
class Metaclass_GetMap2(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_map2.Metaclass_GetMap2_Event._TYPE_SUPPORT is None:
                _get_map2.Metaclass_GetMap2_Event.__import_type_support__()
...
class GetMap2(metaclass=Metaclass_GetMap2):
    ...
    from rtabmap_msgs.srv._get_map2 import GetMap2_Event as Event
