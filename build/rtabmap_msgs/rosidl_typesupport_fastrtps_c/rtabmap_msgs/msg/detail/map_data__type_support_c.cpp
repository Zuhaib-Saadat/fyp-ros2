  ...
  rtabmap_msgs__msg__MapData * ros_message)
{
  ...
  // Field name: graph
  {
    cdr_deserialize_rtabmap_msgs__msg__MapGraph(cdr, &ros_message->graph);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtabmap_msgs__msg__MapData;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rtabmap_msgs__msg__MapData * ros_message = static_cast<const rtabmap_msgs__msg__MapData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rtabmap_msgs__msg__MapData(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rtabmap_msgs__msg__MapData * ros_message = static_cast<rtabmap_msgs__msg__MapData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rtabmap_msgs__msg__MapData(cdr, ros_message);
}
...
static size_t _MapData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rtabmap_msgs__msg__MapData(
