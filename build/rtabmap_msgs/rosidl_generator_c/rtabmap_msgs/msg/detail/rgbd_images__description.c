...
rtabmap_msgs__msg__RGBDImages__get_type_hash(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0xaf, 0x1c, 0x99, 0x2f, 0xf7, 0x47, 0xec, 0xd5,
      0xe1, 0xbe, 0xe7, 0x53, 0x37, 0x6d, 0x01, 0xd5,
      0x26, 0x26, 0x15, 0xd2, 0xb6, 0x9a, 0x0a, 0xe1,
      0x88, 0x0c, 0xe6, 0x83, 0xd0, 0xfc, 0x4a, 0x3e,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t rtabmap_msgs__msg__RGBDImage__EXPECTED_HASH = {1, {
...
static char rtabmap_msgs__msg__RGBDImages__TYPE_NAME[] = "rtabmap_msgs/msg/RGBDImages";
...
static char rtabmap_msgs__msg__RGBDImages__FIELD_NAME__header[] = "header";
static char rtabmap_msgs__msg__RGBDImages__FIELD_NAME__rgbd_images[] = "rgbd_images";

static rosidl_runtime_c__type_description__Field rtabmap_msgs__msg__RGBDImages__FIELDS[] = {
  {
    {rtabmap_msgs__msg__RGBDImages__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {rtabmap_msgs__msg__RGBDImages__FIELD_NAME__rgbd_images, 11, 11},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rtabmap_msgs__msg__RGBDImages__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
rtabmap_msgs__msg__RGBDImages__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {rtabmap_msgs__msg__RGBDImages__TYPE_NAME, 27, 27},
      {rtabmap_msgs__msg__RGBDImages__FIELDS, 2, 2},
    },
    {rtabmap_msgs__msg__RGBDImages__REFERENCED_TYPE_DESCRIPTIONS, 11, 11},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&rtabmap_msgs__msg__RGBDImage__EXPECTED_HASH, rtabmap_msgs__msg__RGBDImage__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[5].fields = rtabmap_msgs__msg__RGBDImage__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[9].fields = sensor_msgs__msg__RegionOfInterest__get_type_description(NULL)->type_description.fields;
...
rtabmap_msgs__msg__RGBDImages__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
rtabmap_msgs__msg__RGBDImages__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rtabmap_msgs__msg__RGBDImages__get_individual_type_description_source(NULL),
    ...
    sources[6] = *rtabmap_msgs__msg__RGBDImage__get_individual_type_description_source(NULL);
    ...
    sources[10] = *sensor_msgs__msg__RegionOfInterest__get_individual_type_description_source(NULL);
