...
static char rtabmap_msgs__msg__MapGraph__FIELD_NAME__header[] = "header";
static char rtabmap_msgs__msg__MapGraph__FIELD_NAME__map_to_odom[] = "map_to_odom";
static char rtabmap_msgs__msg__MapGraph__FIELD_NAME__poses_id[] = "poses_id";
static char rtabmap_msgs__msg__MapGraph__FIELD_NAME__poses[] = "poses";
static char rtabmap_msgs__msg__MapGraph__FIELD_NAME__links[] = "links";

static rosidl_runtime_c__type_description__Field rtabmap_msgs__msg__MapGraph__FIELDS[] = {
  {
    {rtabmap_msgs__msg__MapGraph__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {rtabmap_msgs__msg__MapGraph__FIELD_NAME__map_to_odom, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {rtabmap_msgs__msg__MapGraph__FIELD_NAME__poses_id, 8, 8},
    {
  ...
  {
    {rtabmap_msgs__msg__MapGraph__FIELD_NAME__poses, 5, 5},
    {
  ...
  {
    {rtabmap_msgs__msg__MapGraph__FIELD_NAME__links, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rtabmap_msgs__msg__MapGraph__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rtabmap_msgs__msg__MapGraph__FIELDS, 5, 5},
    },
    {rtabmap_msgs__msg__MapGraph__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
...
rtabmap_msgs__msg__MapGraph__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rtabmap_msgs__msg__MapGraph__get_individual_type_description_source(NULL),
