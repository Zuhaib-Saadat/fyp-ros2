...
// IWYU pragma: private, include "rtabmap_msgs/msg/gps.h"


#ifndef RTABMAP_MSGS__MSG__DETAIL__GPS__FUNCTIONS_H_
#define RTABMAP_MSGS__MSG__DETAIL__GPS__FUNCTIONS_H_
 ...
 * calls
 * rtabmap_msgs__msg__GPS__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_msgs
rtabmap_msgs__msg__GPS *
rtabmap_msgs__msg__GPS__create(void);

/// Destroy msg/GPS message.
/**
 * It calls
 * rtabmap_msgs__msg__GPS__fini()
 ...
 * rtabmap_msgs__msg__GPS__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rtabmap_msgs__msg__GPS__Sequence__fini()
 * on the array,
...
#endif  // RTABMAP_MSGS__MSG__DETAIL__GPS__FUNCTIONS_H_
