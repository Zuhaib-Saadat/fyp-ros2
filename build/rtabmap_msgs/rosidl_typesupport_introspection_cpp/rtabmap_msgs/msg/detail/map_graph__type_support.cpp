...
void fetch_function__MapGraph__links(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const rtabmap_msgs::msg::Link *>(
    get_const_function__MapGraph__links(untyped_member, index));
  auto & value = *reinterpret_cast<rtabmap_msgs::msg::Link *>(untyped_value);
  value = item;
}

void assign_function__MapGraph__links(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<rtabmap_msgs::msg::Link *>(
    get_function__MapGraph__links(untyped_member, index));
  const auto & value = *reinterpret_cast<const rtabmap_msgs::msg::Link *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MapGraph_message_member_array[5] = {
  ...
  },
  {
    ...
    fetch_function__MapGraph__links,  // fetch(index, &value) function pointer
    assign_function__MapGraph__links,  // assign(index, value) function pointer
