...
rtabmap_msgs__srv__LoadDatabase_Request__create(void)
{
...
rtabmap_msgs__srv__LoadDatabase_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
rtabmap_msgs__srv__LoadDatabase_Event__init(rtabmap_msgs__srv__LoadDatabase_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    rtabmap_msgs__srv__LoadDatabase_Event__fini(msg);
    return false;
  }
  // request
  if (!rtabmap_msgs__srv__LoadDatabase_Request__Sequence__init(&msg->request, 0)) {
    rtabmap_msgs__srv__LoadDatabase_Event__fini(msg);
    return false;
  }
  // response
  if (!rtabmap_msgs__srv__LoadDatabase_Response__Sequence__init(&msg->response, 0)) {
    rtabmap_msgs__srv__LoadDatabase_Event__fini(msg);
    return false;
  }
  return true;
...
void
rtabmap_msgs__srv__LoadDatabase_Event__fini(rtabmap_msgs__srv__LoadDatabase_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  rtabmap_msgs__srv__LoadDatabase_Request__Sequence__fini(&msg->request);
  // response
  rtabmap_msgs__srv__LoadDatabase_Response__Sequence__fini(&msg->response);
}

bool
rtabmap_msgs__srv__LoadDatabase_Event__are_equal(const rtabmap_msgs__srv__LoadDatabase_Event * lhs, const rtabmap_msgs__srv__LoadDatabase_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!rtabmap_msgs__srv__LoadDatabase_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!rtabmap_msgs__srv__LoadDatabase_Response__Sequence__are_equal(
...
bool
rtabmap_msgs__srv__LoadDatabase_Event__copy(
  const rtabmap_msgs__srv__LoadDatabase_Event * input,
  rtabmap_msgs__srv__LoadDatabase_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!rtabmap_msgs__srv__LoadDatabase_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!rtabmap_msgs__srv__LoadDatabase_Response__Sequence__copy(
...
rtabmap_msgs__srv__LoadDatabase_Event *
rtabmap_msgs__srv__LoadDatabase_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_msgs__srv__LoadDatabase_Event * msg = (rtabmap_msgs__srv__LoadDatabase_Event *)allocator.allocate(sizeof(rtabmap_msgs__srv__LoadDatabase_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rtabmap_msgs__srv__LoadDatabase_Event));
  bool success = rtabmap_msgs__srv__LoadDatabase_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
rtabmap_msgs__srv__LoadDatabase_Event__destroy(rtabmap_msgs__srv__LoadDatabase_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rtabmap_msgs__srv__LoadDatabase_Event__fini(msg);
...
bool
rtabmap_msgs__srv__LoadDatabase_Event__Sequence__init(rtabmap_msgs__srv__LoadDatabase_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_msgs__srv__LoadDatabase_Event * data = NULL;

  if (size) {
    data = (rtabmap_msgs__srv__LoadDatabase_Event *)allocator.zero_allocate(size, sizeof(rtabmap_msgs__srv__LoadDatabase_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rtabmap_msgs__srv__LoadDatabase_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        rtabmap_msgs__srv__LoadDatabase_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
rtabmap_msgs__srv__LoadDatabase_Event__Sequence__fini(rtabmap_msgs__srv__LoadDatabase_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      rtabmap_msgs__srv__LoadDatabase_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
rtabmap_msgs__srv__LoadDatabase_Event__Sequence *
rtabmap_msgs__srv__LoadDatabase_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_msgs__srv__LoadDatabase_Event__Sequence * array = (rtabmap_msgs__srv__LoadDatabase_Event__Sequence *)allocator.allocate(sizeof(rtabmap_msgs__srv__LoadDatabase_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rtabmap_msgs__srv__LoadDatabase_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
rtabmap_msgs__srv__LoadDatabase_Event__Sequence__destroy(rtabmap_msgs__srv__LoadDatabase_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rtabmap_msgs__srv__LoadDatabase_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
rtabmap_msgs__srv__LoadDatabase_Event__Sequence__are_equal(const rtabmap_msgs__srv__LoadDatabase_Event__Sequence * lhs, const rtabmap_msgs__srv__LoadDatabase_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rtabmap_msgs__srv__LoadDatabase_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rtabmap_msgs__srv__LoadDatabase_Event__Sequence__copy(
  const rtabmap_msgs__srv__LoadDatabase_Event__Sequence * input,
  rtabmap_msgs__srv__LoadDatabase_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rtabmap_msgs__srv__LoadDatabase_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rtabmap_msgs__srv__LoadDatabase_Event * data =
      (rtabmap_msgs__srv__LoadDatabase_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rtabmap_msgs__srv__LoadDatabase_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rtabmap_msgs__srv__LoadDatabase_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!rtabmap_msgs__srv__LoadDatabase_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
