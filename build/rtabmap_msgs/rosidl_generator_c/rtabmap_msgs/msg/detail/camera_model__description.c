...
static char rtabmap_msgs__msg__CameraModel__FIELD_NAME__camera_info[] = "camera_info";
static char rtabmap_msgs__msg__CameraModel__FIELD_NAME__local_transform[] = "local_transform";

static rosidl_runtime_c__type_description__Field rtabmap_msgs__msg__CameraModel__FIELDS[] = {
  {
    {rtabmap_msgs__msg__CameraModel__FIELD_NAME__camera_info, 11, 11},
    {
  ...
  {
    {rtabmap_msgs__msg__CameraModel__FIELD_NAME__local_transform, 15, 15},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rtabmap_msgs__msg__CameraModel__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {rtabmap_msgs__msg__CameraModel__FIELDS, 2, 2},
    },
    {rtabmap_msgs__msg__CameraModel__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
...
rtabmap_msgs__msg__CameraModel__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rtabmap_msgs__msg__CameraModel__get_individual_type_description_source(NULL),
