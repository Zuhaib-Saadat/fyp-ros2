  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtabmap_msgs::msg::ScanDescriptor;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rtabmap_msgs
max_serialized_size_key_ScanDescriptor(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _ScanDescriptor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ScanDescriptor(full_bounded, is_plain, 0);
