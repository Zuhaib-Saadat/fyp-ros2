...
class GetPlan_Event(metaclass=Metaclass_GetPlan_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rtabmap_msgs/GetPlan_Request, 1>',
        'response': 'sequence<rtabmap_msgs/GetPlan_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'srv'], 'GetPlan_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'srv'], 'GetPlan_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rtabmap_msgs.srv import GetPlan_Request
    ...
    def response(self, value):
        if self._check_fields:
            from rtabmap_msgs.srv import GetPlan_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class GetPlan(metaclass=Metaclass_GetPlan):
    ...
    from rtabmap_msgs.srv._get_plan import GetPlan_Event as Event
