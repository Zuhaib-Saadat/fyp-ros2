...
bool cdr_serialize_rtabmap_msgs__msg__CameraModel(
  const rtabmap_msgs__msg__CameraModel * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_rtabmap_msgs__msg__CameraModel(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_msgs__msg__CameraModel * ros_message);
...
bool cdr_serialize_key_rtabmap_msgs__msg__CameraModel(
  const rtabmap_msgs__msg__CameraModel * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_rtabmap_msgs__msg__CameraModel(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_rtabmap_msgs__msg__CameraModel(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: models
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_rtabmap_msgs__msg__CameraModel(
        &array_ptr[i], cdr);
    }
  }
  ...
  rtabmap_msgs__msg__CameraModels * ros_message)
{
  // Field name: models
  {
    ...
    auto array_ptr = ros_message->models.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_rtabmap_msgs__msg__CameraModel(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: models
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_rtabmap_msgs__msg__CameraModel(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: models
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_rtabmap_msgs__msg__CameraModel(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: models
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_rtabmap_msgs__msg__CameraModel(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rtabmap_msgs__msg__CameraModels * ros_message = static_cast<const rtabmap_msgs__msg__CameraModels *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rtabmap_msgs__msg__CameraModels(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rtabmap_msgs__msg__CameraModels * ros_message = static_cast<rtabmap_msgs__msg__CameraModels *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rtabmap_msgs__msg__CameraModels(cdr, ros_message);
}
