...
// IWYU pragma: private, include "rtabmap_msgs/msg/map_graph.h"


#ifndef RTABMAP_MSGS__MSG__DETAIL__MAP_GRAPH__FUNCTIONS_H_
#define RTABMAP_MSGS__MSG__DETAIL__MAP_GRAPH__FUNCTIONS_H_
 ...
 * calls
 * rtabmap_msgs__msg__MapGraph__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_msgs
rtabmap_msgs__msg__MapGraph *
rtabmap_msgs__msg__MapGraph__create(void);

/// Destroy msg/MapGraph message.
/**
 * It calls
 * rtabmap_msgs__msg__MapGraph__fini()
 ...
 * rtabmap_msgs__msg__MapGraph__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rtabmap_msgs__msg__MapGraph__Sequence__fini()
 * on the array,
...
#endif  // RTABMAP_MSGS__MSG__DETAIL__MAP_GRAPH__FUNCTIONS_H_
