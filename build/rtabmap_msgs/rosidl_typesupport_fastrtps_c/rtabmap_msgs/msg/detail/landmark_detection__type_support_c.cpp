  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rtabmap_msgs__msg__LandmarkDetection * ros_message = static_cast<const rtabmap_msgs__msg__LandmarkDetection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rtabmap_msgs__msg__LandmarkDetection(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rtabmap_msgs__msg__LandmarkDetection * ros_message = static_cast<rtabmap_msgs__msg__LandmarkDetection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rtabmap_msgs__msg__LandmarkDetection(cdr, ros_message);
}
