  ...
  rtabmap_msgs__msg__CameraModel * ros_message)
{
  ...
  // Field name: local_transform
  {
    cdr_deserialize_geometry_msgs__msg__Transform(cdr, &ros_message->local_transform);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtabmap_msgs__msg__CameraModel;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rtabmap_msgs__msg__CameraModel * ros_message = static_cast<const rtabmap_msgs__msg__CameraModel *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rtabmap_msgs__msg__CameraModel(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rtabmap_msgs__msg__CameraModel * ros_message = static_cast<rtabmap_msgs__msg__CameraModel *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rtabmap_msgs__msg__CameraModel(cdr, ros_message);
}
...
static size_t _CameraModel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rtabmap_msgs__msg__CameraModel(
...
static rosidl_message_type_support_t _CameraModel__type_support = {
  ...
  &rtabmap_msgs__msg__CameraModel__get_type_hash,
  &rtabmap_msgs__msg__CameraModel__get_type_description,
  &rtabmap_msgs__msg__CameraModel__get_type_description_sources,
};
