...
class Init_GetMap2_Event_response
{
public:
  explicit Init_GetMap2_Event_response(::rtabmap_msgs::srv::GetMap2_Event & msg)
  : msg_(msg)
  {}
  ::rtabmap_msgs::srv::GetMap2_Event response(::rtabmap_msgs::srv::GetMap2_Event::_response_type arg)
  {
...
private:
  ::rtabmap_msgs::srv::GetMap2_Event msg_;
};

class Init_GetMap2_Event_request
{
public:
  explicit Init_GetMap2_Event_request(::rtabmap_msgs::srv::GetMap2_Event & msg)
  : msg_(msg)
  {}
  Init_GetMap2_Event_response request(::rtabmap_msgs::srv::GetMap2_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GetMap2_Event_response(msg_);
  }
...
class Init_GetMap2_Event_info
{
public:
  Init_GetMap2_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetMap2_Event_request info(::rtabmap_msgs::srv::GetMap2_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GetMap2_Event_request(msg_);
  }
...
template<>
inline
auto build<::rtabmap_msgs::srv::GetMap2_Event>()
{
  return rtabmap_msgs::srv::builder::Init_GetMap2_Event_info();
}
