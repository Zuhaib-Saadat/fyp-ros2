...
void fetch_function__Link__information(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__Link__information(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__Link__information(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__Link__information(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Link_message_member_array[5] = {
  ...
  },
  {
    ...
    fetch_function__Link__information,  // fetch(index, &value) function pointer
    assign_function__Link__information,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
