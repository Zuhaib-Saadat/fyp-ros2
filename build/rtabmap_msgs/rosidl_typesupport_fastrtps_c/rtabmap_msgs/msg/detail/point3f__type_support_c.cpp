  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rtabmap_msgs__msg__Point3f;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rtabmap_msgs__msg__Point3f * ros_message = static_cast<const rtabmap_msgs__msg__Point3f *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rtabmap_msgs__msg__Point3f(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rtabmap_msgs__msg__Point3f * ros_message = static_cast<rtabmap_msgs__msg__Point3f *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rtabmap_msgs__msg__Point3f(cdr, ros_message);
}
...
static size_t _Point3f__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_rtabmap_msgs__msg__Point3f(
