...
static const _LoadDatabase_Request_type_support_symbol_names_t _LoadDatabase_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, srv, LoadDatabase_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, LoadDatabase_Request)),
  }
};
...
{
  return &::rtabmap_msgs::srv::rosidl_typesupport_cpp::LoadDatabase_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rtabmap_msgs, srv, LoadDatabase_Request)() {
  return get_message_type_support_handle<rtabmap_msgs::srv::LoadDatabase_Request>();
}
...
static const _LoadDatabase_Response_type_support_symbol_names_t _LoadDatabase_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, srv, LoadDatabase_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, LoadDatabase_Response)),
  }
};
...
{
  return &::rtabmap_msgs::srv::rosidl_typesupport_cpp::LoadDatabase_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rtabmap_msgs, srv, LoadDatabase_Response)() {
  return get_message_type_support_handle<rtabmap_msgs::srv::LoadDatabase_Response>();
}
...
typedef struct _LoadDatabase_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _LoadDatabase_Event_type_support_ids_t;

static const _LoadDatabase_Event_type_support_ids_t _LoadDatabase_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _LoadDatabase_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _LoadDatabase_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _LoadDatabase_Event_type_support_symbol_names_t _LoadDatabase_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, srv, LoadDatabase_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, LoadDatabase_Event)),
  }
};

typedef struct _LoadDatabase_Event_type_support_data_t
{
  void * data[2];
} _LoadDatabase_Event_type_support_data_t;

static _LoadDatabase_Event_type_support_data_t _LoadDatabase_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _LoadDatabase_Event_message_typesupport_map = {
  2,
  "rtabmap_msgs",
  &_LoadDatabase_Event_message_typesupport_ids.typesupport_identifier[0],
  &_LoadDatabase_Event_message_typesupport_symbol_names.symbol_name[0],
  &_LoadDatabase_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t LoadDatabase_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_LoadDatabase_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::rtabmap_msgs::srv::rosidl_typesupport_cpp::LoadDatabase_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rtabmap_msgs, srv, LoadDatabase_Event)() {
  return get_message_type_support_handle<rtabmap_msgs::srv::LoadDatabase_Event>();
}
...
static const _LoadDatabase_type_support_symbol_names_t _LoadDatabase_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_msgs, srv, LoadDatabase)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_msgs, srv, LoadDatabase)),
  }
};
...
static const rosidl_service_type_support_t LoadDatabase_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rtabmap_msgs::srv::LoadDatabase_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rtabmap_msgs::srv::LoadDatabase_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rtabmap_msgs::srv::LoadDatabase_Event>(),
...
{
  return &::rtabmap_msgs::srv::rosidl_typesupport_cpp::LoadDatabase_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, rtabmap_msgs, srv, LoadDatabase)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<rtabmap_msgs::srv::LoadDatabase>();
}
