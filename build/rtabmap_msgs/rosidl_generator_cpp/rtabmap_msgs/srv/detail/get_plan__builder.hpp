...
{
public:
  explicit Init_GetPlan_Event_response(::rtabmap_msgs::srv::GetPlan_Event & msg)
  : msg_(msg)
  {}
  ::rtabmap_msgs::srv::GetPlan_Event response(::rtabmap_msgs::srv::GetPlan_Event::_response_type arg)
  {
...
private:
  ::rtabmap_msgs::srv::GetPlan_Event msg_;
};

class Init_GetPlan_Event_request
{
public:
  explicit Init_GetPlan_Event_request(::rtabmap_msgs::srv::GetPlan_Event & msg)
  : msg_(msg)
  {}
  Init_GetPlan_Event_response request(::rtabmap_msgs::srv::GetPlan_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetPlan_Event_request info(::rtabmap_msgs::srv::GetPlan_Event::_info_type arg)
  {
...
template<>
inline
auto build<::rtabmap_msgs::srv::GetPlan_Event>()
{
  return rtabmap_msgs::srv::builder::Init_GetPlan_Event_info();
}
