...
// IWYU pragma: private, include "rtabmap_msgs/msg/path.h"


#ifndef RTABMAP_MSGS__MSG__DETAIL__PATH__FUNCTIONS_H_
#define RTABMAP_MSGS__MSG__DETAIL__PATH__FUNCTIONS_H_
 ...
 * calls
 * rtabmap_msgs__msg__Path__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rtabmap_msgs
rtabmap_msgs__msg__Path *
rtabmap_msgs__msg__Path__create(void);

/// Destroy msg/Path message.
/**
 * It calls
 * rtabmap_msgs__msg__Path__fini()
 ...
 * rtabmap_msgs__msg__Path__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rtabmap_msgs__msg__Path__Sequence__fini()
 * on the array,
...
#endif  // RTABMAP_MSGS__MSG__DETAIL__PATH__FUNCTIONS_H_
