...
static const _GlobalBundleAdjustment_Event_type_support_symbol_names_t _GlobalBundleAdjustment_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_msgs, srv, GlobalBundleAdjustment_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_msgs, srv, GlobalBundleAdjustment_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rtabmap_msgs, srv, GlobalBundleAdjustment_Event)() {
  return &::rtabmap_msgs::srv::rosidl_typesupport_c::GlobalBundleAdjustment_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GlobalBundleAdjustment_service_type_support_handle = {
  ...
  &GlobalBundleAdjustment_Request_message_type_support_handle,
  &GlobalBundleAdjustment_Response_message_type_support_handle,
  &GlobalBundleAdjustment_Event_message_type_support_handle,
